...
class IMDBlock(nn.Module):
    ...
    def forward(self, x):
        d1, r1 = torch.split(self.conv1(x), (self.d_nc, self.r_nc), dim=1)  # type: ignore
        d2, r2 = torch.split(self.conv2(r1), (self.d_nc, self.r_nc), dim=1)  # type: ignore
        d3, r3 = torch.split(self.conv3(r2), (self.d_nc, self.r_nc), dim=1)  # type: ignore
        d4 = self.conv4(r3)
