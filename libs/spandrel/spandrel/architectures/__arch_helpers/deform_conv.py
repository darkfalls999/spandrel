...
#_onnx_symbolic = functools.partial(registration.onnx_symbolic, custom=True, opset=20)

#@_onnx_symbolic("custom_domain::DeformConv2D")
...
#        padding_i=[pad_h, pad_w],
#        dilation_i=[dil_h, dil_w],
#        n_weight_grps_i=n_weight_grps,
#        n_offset_grps_i=n_offset_grps,
#        use_mask_i=1 if use_mask else 0
#    )

#register_custom_op_symbolic(
#    "torchvision::deform_conv2d",  # Operator namespace and name in PyTorch
#    deform_conv2d_symbolic,        # Your symbolic function
#    20                             # ONNX opset version to register under
#    )
